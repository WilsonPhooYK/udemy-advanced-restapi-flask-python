...
class ImageUpload(Resource):
    ...
    def post(cls):
        ...
        """
        data:dict[str, FileStorage] = image_schema.load(request.files) # type: ignore # {"image": FileStorage}
...
class AvatarUpload(Resource):
    ...
    def put(cls):
        ...
        """
        data:dict[str, FileStorage] = image_schema.load(request.files) # type: ignore
        ...
        try:
            ext = image_helper.get_extension(data["image"].filename) # type: ignore
            avatar = filename + ext
